    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.URLField(blank=True, null=True, verbose_name='Ссылка на картинку на сайте')),
                ('text', models.TextField(verbose_name='Описание')),
                ('cooking_time', models.PositiveSmallIntegerField(default=None, validators=[recipes_app.validators.validate_time], verbose_name='Время приготовления (в минутах)')),
